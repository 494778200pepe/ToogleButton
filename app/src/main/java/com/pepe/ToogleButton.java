...
import com.pepe.tooglebutton.R;
...
public class ToogleButton extends View {
    ...
    public ToogleButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        // 边线颜色
        borderColor = array.getColor(R.styleable.ToogleButton_border_color, Color.parseColor("#04937A"));

        //背景颜色
        checkedBgColor = array.getColor(R.styleable.ToogleButton_checked_bg_color, Color.parseColor("#D4FFF8"));
        uncheckedBgColor = array.getColor(R.styleable.ToogleButton_unchecked_bg_color, Color.WHITE);

        // 按钮颜色
        buttonColor = array.getColor(R.styleable.ToogleButton_button_color, Color.parseColor("#22D7B7"));
        //开关圆形按钮的圆环颜色
        buttonRingColor = array.getColor(R.styleable.ToogleButton_button_ring_color, Color.parseColor("#04937A"));
        //开关圆形按钮的圆环宽度
